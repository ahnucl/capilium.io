    ...
    <div id="main" class="container-fluid bg-light p-3" style="margin-top: 4em">
        ...
        <div id="top" class="row">
            ...
            <div class="text-right col-sm-3 pr-4">
                <a href="form-servico.jsp" class="btn btn-outline-success h2"><span class="fa fa-plus fa-fw"></span>Cadastrar Serviço</a>
            </div>
        </div> 
            ...
            <table class="table table-striped" cellspacing="0" cellpadding="0">
                ...
                <%
                    ...
                    for (int i = 0; i < listaServico.size(); i++) {
                        ...
                        para realizar a exclusão ou alteração do Servico selecionado*/
