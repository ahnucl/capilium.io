...
public class EditarFuncionario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ManterFuncionarioDAO funcionarioDAO = new ManterFuncionarioDAO();
        Funcionario funcionario = new Funcionario();
        
        funcionario.setIdFuncionario(Integer.valueOf(request.getParameter("idFuncionario")));
        funcionario.setMatricula(request.getParameter("matricula"));
        funcionario.setNome(request.getParameter("nome"));
        
        if (funcionarioDAO.verificaMatriculaExistente(funcionario.getMatricula(),funcionario.getIdFuncionario())) {
